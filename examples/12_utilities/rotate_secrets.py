...
class SecretsRotationManager:
    ...
    def refresh_secrets(self, secret_type: Optional[str] = None,
        ...
        Args:
            secret_type: Optional type of secrets to refresh
        ...
        try:
            ...
            refresh_request = SecretsManagerRefreshRequest()
            
            if secret_type:
                refresh_request.secret_type = secret_type
            
            if force:
                refresh_request.force_refresh = True
                self._log("Force refresh enabled")
            ...
            if response:
                ...
                # Extract refreshed secrets info (simplified)
...
Examples:
  ...
  # Refresh specific secret type
  %(prog)s --refresh --type api_keys
